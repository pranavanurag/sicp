...
(define i1 (make-center-percent 12 0.01))
;Value: i1

1 ]=> ;0.1%
(define i2 (make-center-percent 15 0.05))
;Value: i2
...
1 ]=> (define mul2 (mul-interval-center-percent i1 i2))
;Value: mul2

1 ]=> (lower-bound mul1)
;Value: 169.29000000000002

1 ]=> (upper-bound mul1)
;Value: 190.89

1 ]=> (lower-bound mul2)
;Value: 169.20539730134934

1 ]=> (upper-bound mul2)
;Value: 190.79460269865066
```